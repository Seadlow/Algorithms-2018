...
abstract class AbstractHeadTailTest {
    ...
    protected fun doHeadSetTest() {
        var set: SortedSet<Int> = tree.headSet(9)
        ...
        assertEquals(false, set.contains(21))
        assertEquals(false, set.contains(14))
        assertEquals(false, set.contains(17))
        assertEquals(false, set.contains(22))
    ...
    protected fun doTailSetTest() {
        var set: SortedSet<Int> = tree.tailSet(7)
        ...
        assertEquals(true, set.contains(44))
        assertEquals(true, set.contains(23))
        assertEquals(true, set.contains(54))
        assertEquals(true, set.contains(10))
